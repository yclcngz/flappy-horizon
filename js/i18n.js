const i18n = {
    tr: {
        ...
        modalShopTitle: "🛒 Geliştirme Marketi",
        shopUpgradeLvl: "Seviye",
        shopMaxLvl: "MAKS",
        shopBuy: "Satın Al",
        shopInsufficient: "Yetersiz Altın",
        shopMagnet: "Mıknatıs",
        shopShield: "Yıkıcı Kalkan",
        shopTornado: "Kasırga",
        shopTime: "Zaman Bükücü",
        shopDescMagnet: "Altın çekim menzilini ve süresini uzatır.",
        shopDescShield: "Duvarları parçalama süresini artırır.",
        shopDescTornado: "Engelleri uçurma süresini uzatır.",
        shopDescTime: "Yavaşlatma etkisinin süresini uzatır.",
        btnClose: "KAPAT",
        // Atölye İçi
    ...
    en: {
        ...
        btnShop: "🛒 SHOP & UPGRADES",
        btnLevels: "🌍 LEVELS & WORLDS",
        ...
        modalShopTitle: "🛒 Upgrade Shop",
        shopUpgradeLvl: "Level",
        shopMaxLvl: "MAX",
        shopBuy: "Buy",
        shopInsufficient: "Not Enough Gold",
        shopMagnet: "Magnet",
        shopShield: "Destructive Shield",
        shopTornado: "Tornado",
        shopTime: "Time Bender",
        shopDescMagnet: "Increases gold pull range and duration.",
        shopDescShield: "Extends wall destruction duration.",
        shopDescTornado: "Extends the time obstacles are blown away.",
        shopDescTime: "Increases the slow-motion duration.",
        btnClose: "CLOSE",
        // Atölye İçi
